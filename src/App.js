  ...
  return (
    <main className="App">
      <div><nav style={{margin:'10px',padding:'10px'}}>
               <button className='btn1'><Link className='nav' to ="/" target="\_blank">Home</Link></button>
               <button className='btn1'>< Link className='nav'   to ="/about-Me" target="\_blank">AboutMe</ Link></button>
